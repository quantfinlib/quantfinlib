...
def macd(ts: pd.Series, fast: int = 12, slow: int = 26) -> pd.Series:
    ...
    Args:
        ...
        fast (int): Number of periods for the fast moving average. Default is 12.
        slow (int): Number of periods for the slow moving average. Default is 26.
...
def macd_signal(ts: pd.Series, fast: int = 12, slow: int = 26, signal: int = 9) -> pd.Series:
    ...
    Args:
        ...
        fast (int): Number of periods for the fast moving average. Default is 12.
        slow (int): Number of periods for the slow moving average. Default is 26.
        signal (int): Number of periods for the signal line. Default is 9.

    Returns:
        pd.Series: The calculated MACD signal values.
    """
